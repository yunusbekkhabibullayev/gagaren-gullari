...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BJLrbqQX.mjs");
...
var manifest = { "d74efaed9d368b50c737966712aaf37f9bc30edca8be1eed754f166b39b69dcd": {
	functionName: "trackOrder_createServerFn_handler",
	importer: () => import("./orders.functions-qGTIqVqW.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Phzk9hL6.mjs").then((n) => n.t),
		import("./start-gFD5iSPX.mjs"),
